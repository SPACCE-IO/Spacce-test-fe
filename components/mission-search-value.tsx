...
const MissionSearchValue = ({ children, title, description }: Employee) => {
    ...
    <section className="min-h-screen grid grid-rows-4 gap-16 p-5 mx-auto container ">
      ...
      <div className="grid grid-cols-5 gap-10 row-span-3  text-2xl font-light">
        ...
        <div className="col-span-2  justify-between grid grid-flow-row">
          <div className="h-[520px] w-[372px] border-neutral-300 bg-neutral-100 justify-center items-center flex rounded-[5px]">
            <ImagesIcon />
          </div>
          <div className="h-10 ">
            <Button className="w-full h-full border border-neutral-200 rounded-[5px] justify-start">Option</Button>
          </div>
        </div>
      </div>
    </section>
...
export default MissionSearchValue
