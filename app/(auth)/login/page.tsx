...
import { useUserLoginMutation } from "@/store/services/authManagement"
import { useLazyGetProfileQuery } from "@/store/services/userManagement"
...
export default function LoginPage() {
 ...
 useEffect(() => {
    if (userLoginProps.isSuccess && userLoginProps.data) {
      ...
      const cookieExpiry = keepLoggedIn ? 30 : 1 // 30 days if keep logged in, 1 day otherwise
      setCookie('userToken', token, cookieExpiry)
      setCookie('authToken', token, cookieExpiry) // Backup cookie name
