...
import { useLazyGetProfileQuery, useResetPasswordMutation } from "@/store/services/userManagement"
import { setToken } from "@/store/slices/tokenSlice"
import { setProfile } from "@/store/slices/profileSlice"
import { getAuthToken, setCookie } from "@/utils/auth"
import { Card, CardContent } from "@/components/ui/card"
import Navbar from "@/components/navbar"
import Footer from "@/components/spacce-footer"
...
export default function ResetPasswordPage() {
  ...
  }, [resetPasswordProps.isSuccess, resetPasswordProps.data, dispatch, getProfile])

  // Handle reset password error
  useEffect(() => {
    if (resetPasswordProps.isError) {
      setResetError("Password reset failed. Please check your passcode and try again.")
    }
          ...
          <CardContent className="p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="text-center space-y-2">
                ...
                <p className="text-gray-400 text-base">Enter your details to reset your password.</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="newPassword" className="text-gray-300 text-base">
                    New Password
                  </Label>
                  <Input
                    id="newPassword"
                    ...
                    required
                    disabled={resetPasswordProps.isLoading || getProfileProps.isLoading}
                  />
                </div>
              ...
              <Button
                ...
                disabled={resetPasswordProps.isLoading || getProfileProps.isLoading}
              >
                {resetPasswordProps.isLoading || getProfileProps.isLoading ? "Resetting Password..." : "Reset Password"}
              </Button>
