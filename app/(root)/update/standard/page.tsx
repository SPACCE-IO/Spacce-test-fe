...
import MissionTasksText from "@/app/components/mission-tasks-text";
...
const Mission = () => {
  ...
  const sampleQuestions = [
    ...
    },
    {
      id: 4,
      question:
        "What advice would they give to someone starting their career at the company?",
      answer: "",
      type: "longText" as const,
      hint: "Focus on valuable insights and lessons learned from their experience",
    },
    {
      id: 5,
      question:
        "What keeps them motivated and engaged after 5+ years at the company?",
      answer: "",
      type: "longText" as const,
      hint: "Think about culture, opportunities, and personal growth factors",
    },
  ];
