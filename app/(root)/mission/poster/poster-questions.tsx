...
const PosterQuestions = ({
  ...
  const handleDropAtPosition = (targetPosition: number, questionId: number) => {
    console.log('Drop attempted at position:', targetPosition, 'with draggedItem:', draggedItem);
                  ...
                  >
                    ...
                    >
                      <div className="flex flex-col gap-2">
                        <div className="flex items-center gap-2">
                          ...
                          {questionStatuses[questionId] === 0 && answers[questionId] && (
                    ...
                    {activeQuestionId === questionId && (
                      <div className="pb-6 border-t pt-4">
                        ...
                        {showResponse && responseMessage && activeQuestionId === questionId && (
                          <div className={`mb-4 p-3 rounded-md flex justify-between items-center ${
                            ...
                            {(!responseMessage.includes('correct') && !responseMessage.includes('Correct')) && (
                              <Button
                                onClick={() => handleRetryQuestion(questionId)}
                                variant="outline"
                                size="sm"
      ...
      {missionStatus === 2 && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-8 text-center">
            ...
            <p className="text-gray-600">Redirecting to congratulations page...</p>
          </div>
        </div>
      )}
    </section>
