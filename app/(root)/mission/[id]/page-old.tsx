  ...
  return (
    <div className="h-screen overflow-hidden">
      ...
      <div ref={containerRef} className="h-full overflow-y-auto snap-y snap-mandatory">
        ...
        <div ref={section2Ref} className="snap-start h-screen flex justify-center items-center">
          <div className="container mx-auto py-16 flex flex-col items-center">
            <h1 className="text-erify-dark text-4xl font-bold text-center py-5">Mission Title</h1>
            <p className="text-center text-[25px] font-light">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut <br /> et massa mi. Aliquam in hendrerit urna.
              Pellentesque sit <br /> amet sapien fringilla, mattis ligula consectetur.
            </p>
            <p className="pt-10">Use Scrollbar to start</p>
            <div className="pb-12">
              <Mouse />
            </div>
            <div className="flex justify-center items-center border border-dashed border-black bg-neutral-100 h-[320px] w-full rounded-[15px]"></div>
          </div>
        </div>
