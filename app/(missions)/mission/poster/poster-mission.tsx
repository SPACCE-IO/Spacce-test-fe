...
import PosterIntro from "./poster-intro";
import PosterQuestions from "./poster-questions";
import Navbar from "@/components/navbar";
import AnimatedMissionBadge from "@/components/AnimatedMissionBadge";
...
interface PosterMissionComponentProps {
  mission: MissionProps;
}

const PosterMission = ({ mission }: PosterMissionComponentProps) => {
